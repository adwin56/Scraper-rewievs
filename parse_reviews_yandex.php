...
echo 'Начинаю парсинг URL: ' . $url . PHP_EOL;
...
echo 'HTML получен, длина: ' . strlen($html) . PHP_EOL;
...
echo 'Найдено отзывов: ' . $reviewNodes->length . PHP_EOL;
...
foreach ($reviewNodes as $node) {
    ...
    echo 'Обработан отзыв от автора: ' . $author . PHP_EOL;
}
...
echo 'Парсинг завершен, отправка данных в формате JSON' . PHP_EOL;
?>
